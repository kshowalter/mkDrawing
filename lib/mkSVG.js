module.exports = function(drawing){
  ...
  var x = drawing.settings.center.x - ( drawing.settings.size.w/2 * drawing.settings.scale );
  var y = drawing.settings.center.y - ( drawing.settings.size.h/2 * drawing.settings.scale );
  var w = drawing.settings.size.w * drawing.settings.scale;
  var h = drawing.settings.size.h * drawing.settings.scale;
  ...
  function mk_svg_elem(geom){
    ...
    var attrs = layer_attr[geom.layer_name];
